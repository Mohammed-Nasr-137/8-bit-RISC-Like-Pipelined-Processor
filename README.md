...
**MetricUsagePercentageSlice LUTs**1009 / 208005%**Slice Registers**1221 / 416003%**Block RAM**1.5 Tile<1%**Power Consumption**0.084 WLow Power**Timing**WNS: +3.066nsMet Constraints
...
_Supervised by Prof. Hossam Fahmy and Eng. Hassan El-Menier._
...
Plain textANTLR4BashCC#CSSCoffeeScriptCMakeDartDjangoDockerEJSErlangGitGoGraphQLGroovyHTMLJavaJavaScriptJSONJSXKotlinLaTeXLessLuaMakefileMarkdownMATLABMarkupObjective-CPerlPHPPowerShell.propertiesProtocol BuffersPythonRRubySass (Sass)Sass (Scss)SchemeSQLShellSwiftSVGTSXTypeScriptWebAssemblyYAMLXML`   ├── src/  │   ├── Control_Unit.v       # Main FSM Control Logic  │   ├── ALU.v                # Arithmetic Logic Unit  │   ├── Hazard_Detection.v   # Load-Use Hazard Unit  │   ├── Forwarding_Unit.v    # Data Forwarding Logic  │   ├── Unified_Memory.v     # Dual-Port Memory Wrapper  │   └── Processor_Top.v      # Top Level Module  ├── sim/  │   ├── Processor_TB_Fib.v   # Fibonacci Testbench  │   ├── Processor_TB_Crit.v  # Critical Edge Case Testbench  │   └── program.mem          # Hex code for testing  ├── docs/  │   ├── Report.pdf           # Final Technical Report  │   └── Slides.pdf           # Presentation Slides  └── README.md   `
